...
(c.messageTop||"")+"</div>"+b+"<div>"+(c.messageBottom||"")+"</div>";d(g.document.body).addClass("dt-print-view");d("img",g.document.body).each(function(a,b){b.setAttribute("src",l(b.getAttribute("src")))});h.customize&&h.customize(g);setTimeout(function(){h.autoPrint&&(g.print(),g.close())},1E3)},title:"SISREUNI Listado de Estudiantes",messageTop:"*",messageBottom:"*",exportOptions:{columns: ":not(.no-exportar)"},header:!0,footer:!1,autoPrint:!0,customize:null};return i.Buttons});
