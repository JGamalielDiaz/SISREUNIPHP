...
<head>
    ...
    <link href="LayoutAssets/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
    <link href="LayoutAssets/assets/css/plugins.css" rel="stylesheet" type="text/css" />
    <link href="LayoutAssets/assets/css/authentication/form-2.css" rel="stylesheet" type="text/css" />
    <!-- END GLOBAL MANDATORY STYLES -->
    <link rel="stylesheet" type="text/css" href="LayoutAssets/assets/css/forms/theme-checkbox-radio.css">
    <link rel="stylesheet" type="text/css" href="LayoutAssets/assets/css/forms/switches.css">
</head>
<body class="form">
                        ...
                        <form class="text-left" method="POST" action="{{route('Login')}}">
                            ...
                            <div class="form">
                                <div id="username-field" class="field-wrapper input ">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user {{$errors->has('username')? 'is-invalid' : ''}}"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                                <input id="email" name="email" type="text" class="form-control" placeholder="e.g John_Doe" value="{{old('email')}}">
    ...
    <script src="LayoutAssets/assets/js/libs/jquery-3.1.1.min.js"></script>
    <script src="LayoutAssets/bootstrap/js/popper.min.js"></script>
    <script src="LayoutAssets/bootstrap/js/bootstrap.min.js"></script>
    
    <!-- END GLOBAL MANDATORY SCRIPTS -->
    <script src="LayoutAssets/assets/js/authentication/form-2.js"></script>
