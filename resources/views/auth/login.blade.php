...
<head>
    ...
    <link href="{{asset('css/cssLayout/form-2.css')}}" rel="stylesheet" type="text/css" />
...
<body class="form">
    ...
    <div class="form-container outer">
        @if (session()->has('flash'))
            <div class="alert alert-danger alert-dismisssible">{{ session('flash') }}
                    ...
                    <div class="form-content">
                        ...
                        <form class="text-left" method="POST" action="{{route('login')}}">
                            ...
                            <div class="form">
                                ...
                                <input id="username" name="username" type="text" class="form-control" placeholder="e.g John_Doe" value="{{old('username')}}">
                                ...
                                <div id="password-field" class="field-wrapper input mb-2 form-group">
                                    ...
                                    <input id="password" name="password" type="password" class="form-control" placeholder="Password" autocomplete="new-password">
    ...
    <script src="{{asset('js/jsLayout/form-2.js')}}"></script>
